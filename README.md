...
Built for Dutch, but NotebookLM supports [80+ languages](https://support.google.com/notebooklm/answer/15738129). Change the `language` parameter in `podcast.py` and you're good.
